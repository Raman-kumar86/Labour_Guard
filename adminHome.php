    ...
    <nav class="bg-blue-600 p-4 text-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
            ...
            <ul class="hidden md:flex space-x-6 mt-4 md:mt-0" id="menu-items">
                <li><a href="homepage.php" class="hover:underline hover:text-yellow-300">🏠Home</a></li>
                ...
                <li><a href="adminComplaintDashboard.php" class="hover:underline hover:text-yellow-300">📝Complaint Dashboard</a></li>
            </ul>
            ...
            <div class="mt-20">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    <div class="bg-blue-50 p-5 rounded-lg">
                        ...
                        <a href="#" class="text-blue-600 hover:underline inline-block mt-2">Read More <i class="fas fa-arrow-right ml-1"></i></a>
                    </div>
                    <div class="bg-blue-50 p-5 rounded-lg">
